...
@section('content')
	...
	<div class="hug hug-header">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <a href="{{ route('home') }}" class="pull-left"><img src="{{ \App\Helpers\Helpers::logoUrl() }}" alt="Delta"></a>
    ...
    <div class="hug hug-hero">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="left-side">
                        <h1>Introducing Delta@3</h1>
                        <h2>A project management system.</h2>
    ...
    <div class="hug hug-features">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="text-center">Delta@3 comes full of easy-to-use & delightful features!</h2>
                </div>
    ...
    <div class="hug hug-exit">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="img">
                        <h2>"Free, easy-to-use, and open source. It's time for you to take the dive."</h2>
                        <a href="{{ route('register') }}" class="btn btn-special">GET STARTED</a>
                    </div>
                </div>
            </div>
    ...
    <div class="hug hug-footer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <hr class="special">
                    <p class="text-center last-line">Copyright {{ date("Y") }} &copy;  <a href="https://github.com/milekag01" target="_blank">MILEK</a></p>
                </div>
            </div>
        </div>
    </div>
